...
const RETRYABLE_BY_CODE = {
  ...
  PI_AGENT_NOT_CONFIGURED: false,
  PI_AGENT_CAPABILITY_MISMATCH: false,
  ...
  DEBUG_BASELINE_INVALID: false,
  MISMATCH_ANALYSIS_FAILED: false,
  EXPERIENCE_SUMMARIZATION_FAILED: false,
  MEMORY_STORE_INVALID: false,
  MEMORY_CONSOLIDATION_FAILED: false,
  COVERAGE_EXPERIMENT_FAILED: false,
